  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden text-white pt-14 md:pt-20 pb-16">
        ...
        />
        {/* Horizontal gradient: dark on the left for text legibility,
            lighter on the right so the photo shows through. */}
        <div
          aria-hidden
          className="absolute inset-0 -z-10 bg-gradient-to-r from-dark/85 via-dark/60 to-dark/30"
        />
        <Container>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
            {others.map((s) => (
              <Link
                ...
                className="group card-light hover:-translate-y-0.5 p-6"
              >
